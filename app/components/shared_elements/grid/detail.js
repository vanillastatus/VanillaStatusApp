/**
 * @providesModule SharedElementDetail
 */
...
@withNavigation
export default class SharedElementDetail extends React.Component {
  static route = {
    navigationBar: {
        ...
        <ScrollView style={{ flex: 1 }}>
          <View style={styles.imageContainer}>
            ...
            <Animated.View style={{ transform: [{ translateY: contentTranslateY }]}}>
              <Text style={styles.descriptionText}>{data.status === true ? 'Server is up!' : 'Server is down!'}</Text>
            </Animated.View>
          </View>
        </ScrollView>
      </View>
